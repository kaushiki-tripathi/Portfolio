    ...
    <div className="w-full max-w-6xl bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden mt-24 md:mt-0 mx-4 md:mx-auto transition-all duration-300">
      ...
      <div className="w-full md:w-1/3 p-6 md:p-8 bg-gray-800/50 flex flex-col items-center text-center">
        ...
        <div className="w-32 h-32 md:w-48 md:h-48 rounded-full bg-green-500/20 flex items-center justify-center border-4 border-green-500 transition-all duration-300">
          <img
            src={profilePic}
            className="w-28 h-28 md:w-44 md:h-44 rounded-full object-cover transition-all duration-300"
            alt="Kaushiki Tripathi
          "
          />
        </div>

        {/* Text sizes reduced for mobile, kept large for desktop */}
        <h1 className="text-2xl md:text-3xl font-bold text-white mt-6 transition-all duration-300">
          Kaushiki Tripathi
        </h1>
        <p className="text-lg md:text-xl text-green-400 mt-1 transition-all duration-300">
          IT Undergraduate
        </p>
        ...
        <p className="text-xs text-gray-500 mt-auto pt-8">
          © 2026 Kaushiki Tripathi. All rights reserved.
        </p>
      </div>

      {/* Right Panel (Details) */}
      <div className="w-full md:w-2/3 p-6 md:p-12">
        <h2 className="text-2xl md:text-3xl font-bold text-white transition-all duration-300">
          About Me
        </h2>
        ...
        <p className="text-sm md:text-base text-gray-300 mt-4 leading-relaxed transition-all duration-300">
          Full Stack Developer with hands-on experience building AI-powered web
          applications using React.js, Node.js, Express.js and MongoDB. Designed
          and implemented production-grade RAG pipelines integrating vector
          databases, LLM APIs, and real-time streaming for intelligent document
          processing. Proficient in REST API development, JWT security,
          Socket.IO and Docker containerization.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 text-sm md:text-base transition-all duration-300">
          <div>
            <span className="text-green-400 font-semibold">Residence:</span>{" "}
            <span className="text-gray-200">India</span>
          </div>
          <div>
            <span className="text-green-400 font-semibold">Address:</span>{" "}
            <span className="text-gray-200">Kanpur, UP</span>
          </div>
          <div>
            <span className="text-green-400 font-semibold">Email:</span>{" "}
            <a
              href="mailto:kaushikitripathi07@gmail.com"
              className="text-gray-200 hover:text-green-400"
            >
              kaushikitripathi07@gmail.com
            </a>
          </div>
        </div>

        <h2 className="text-2xl md:text-3xl font-bold text-white mt-10 transition-all duration-300">
          What I Do
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-lg md:text-xl font-semibold text-white transition-all duration-300">
                Full-Stack Development
              </h3>
              <p className="text-sm md:text-base text-gray-400 mt-2 transition-all duration-300">
                Building responsive, real-time applications with the MERN stack
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm md:text-base text-gray-400 mt-2 transition-all duration-300">
                Applying a strong background in DSA. (5-Star HackerRank, 230+
                LeetCode problems).
              </p>
            </div>
          </div>
